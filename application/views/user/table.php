                    ...
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                           <li><a  href="<?php echo base_url('/Pajak_ctrl/menu/userhome'); ?>">Home</a></li>
                            <li><a class="menu-top-active" href="<?php echo base_url('/Pajak_ctrl/menu/usertable'); ?>">Cek Status</a></li>
								...
								<br>
                                    <thead>
                                        <tr>
                                            ...
                                            <th>tanggal cetak STNK</th>
                                            <th>Status_Sekarang</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td><?php echo $status['No_KTP'];?></td>
                                            <td><?php echo $status['No_Kendaraan'];?></td>
                                            <td><?php echo $STNK['Tanggal_Cetal_STNK'];?></td>
                                            <td><?php echo $status['status_sekarang'];?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
