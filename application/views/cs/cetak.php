                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
							...
							<li><a class="menu-top-active" href="<?php echo base_url('/Pajak_ctrl/menu/cscetak'); ?>">Cetak Dokumen dan STNK</a></li>
                        </ul>
                    </div>
                </div>
								...
								<br>
                                    ...
                                    <?php $i=1 ;foreach ($list as $row){?>
                                        <tr> 
                            				...
                            				<td><?php echo $row['no_ken_new'];?></td>
											<td><a href="<?php echo base_url('/Pajak_ctrl/done/'.$row['id_pengajuan']);?>"><button type="button" class="btn btn-info">Sudah Cetak</button></a></td>
                                        </tr>
                                       <?php $i++;}?>
                                    </tbody>
                                </table>
