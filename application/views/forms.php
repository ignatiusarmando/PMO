                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="<?php echo base_url('/Pajak_ctrl/menu/b'); ?>">Cari</a></li>
                            <li><a class="menu-top-active" href="<?php echo base_url('/Pajak_ctrl/menu/c'); ?>">Upload</a></li>
              ...
              <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                       ...
                       <form action="<?php echo base_url('/Pajak_ctrl/menu/a'); ?>" method="post" >
  <div class="form-group">
    <label for="no_ktp">Nomor KTP</label>
    <input type="text" class="form-control" id="no_ktp" placeholder="Enter No. KTP" />
    <label for="no_ktp">Nomor STNK</label>
    <input type="text" class="form-control" id="no_ktp" placeholder="Enter No. STNK" />
    ...
    <input type="password" class="form-control" id="no_hp" placeholder="Enter No. HP" />
